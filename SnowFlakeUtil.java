...
/**
 * Title: SnowFlakeUtil<br>
 * Description: SnowFlakeUtil<br>
 * Company:韦博英语在线教育部</br>
 * CreateDate:2019年01月22日 13:33
 *
 * @author james.fxy
 */
public class SnowFlakeUtil {
  ...
  public SnowFlakeUtil(long workerId, long datacenterId) {
    ...
    if (datacenterId > MAX_DATACENTER_ID || datacenterId < 0) {
      throw new IllegalArgumentException(String.format("DataCenterID 不能大于 %d 或小于 0",
          MAX_DATACENTER_ID));
    }
  ...
  public static void main(String[] args) {
    final SnowFlakeUtil idGenerator = new SnowFlakeUtil(3, 3);
    // 线程池并行执行10000次ID生成
  ...
  /**
   * Title: 获取18位orderID<br>
   * Description: 获取orderID<br>
   * CreateDate: 2019/1/22 15:16<br>
   *
   * @category 获取orderID
   * @author james.fxy
   * @param
   ...
   * @exception Exception
   */
  public static long obtainOrderId(long workerId, long datacenterId) {
    final SnowFlakeUtil idGenerator = new SnowFlakeUtil(workerId, datacenterId);
